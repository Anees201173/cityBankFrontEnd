...
function HomeCom_9() {
    return (
        <div className="w-full h-screen bg-[#03020C] text-white flex justify-center items-center">
            <div className="bg-[#151515] p-6 md:p-12 w-[90%] md:w-[70%] max-w-[1100px] h-auto rounded-[30px] flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-col justify-center items-center text-center gap-6 md:gap-8">
                    <h1 className="text-xl sm:text-2xl md:text-2xl lg:text-4 font-bold max-w-[400px]">
