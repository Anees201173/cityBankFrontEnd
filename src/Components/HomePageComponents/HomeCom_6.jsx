    ...
    <>
      <div className="bg-[#03020C] w-full min-h-screen text-white flex flex-col lg:flex-row justify-center items-center lg:items-start p-4">
        ...
        <div className="flex flex-col gap-y-6 mt-8 lg:mt-[60px] w-full lg:w-auto lg:ml-[110px]">
          <select className="w-[100%] sm:w-full md:w-[600px] h-[70px] bg-[#151515] text-white rounded-[15px] p-2 outline-none transition-all text-[16px] sm:text-[20px] font-semibold">
            <option value="free">What are the benefits of using digital banking?</option>
          </select>

          <select className="w-[100%] sm:w-full md:w-[600px] h-[70px] bg-[#151515] text-white rounded-lg p-2 outline-none transition-all text-[16px] sm:text-[20px] font-semibold">
