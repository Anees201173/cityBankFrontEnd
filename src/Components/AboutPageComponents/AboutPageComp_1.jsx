    ...
    <>
      <div className="py-8 sm:py-12 md:py-16 ">
        ...
        <motion.div
          ...
          className="flex flex-col justify-center items-center mt-8 sm:mt-12 md:mt-12"
        >
        ...
        <div className="flex justify-center items-center text-white">
          <div className="flex flex-col justify-center items-center px-4 sm:px-6 md:px-12">
            ...
            <div className="w-full sm:w-[600px] md:w-[900px] text-2xl sm:text-3xl md:text-4xl text-center mt-[40px]">
              <p>
                ...
                <span className="text-[#5A5A5A]">
                  {" "}
                  At Citybank, we're your financial partner, dedicated to
                  helping you achieve your goals.
                </span>
                <span className="text-[#B1B1B1]">
                  {" "}
                  We understand that everyone's financial journey
                </span>
                <span className="text-[#5A5A5A]">
                  {" "}
                  is unique, and that's why we offer a secure and innovative
                  digital banking platform designed to simplify your finances
            ...
            <div className="flex justify-center gap-x-6 items-center mt-[50px] text-[#B1B1B1] text-3xl sm:text-4xl md:text-5xl font-bold">
              <div className="border-r-[2px] pr-8">124M+</div>
              <div className="border-r-[2px] pr-8">5.00</div>
