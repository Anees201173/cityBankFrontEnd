    ...
    <footer className="bg-black text-white py-10 px-4 md:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        <div className="col-span-1 lg:col-span-2">
          ...
          <p className="text-sm">
            We're more than just a bank. At Iswiss Bank, we're your financial
            partner.
          </p>
        </div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <span className="flex items-center gap-2">
                <FaEnvelope />
                <a href="mailto:contact@Iswiss Bank.com">
                  contact@Iswiss Bank.com
                </a>
              </span>
            </li>
            <li>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <form className="flex flex-col md:flex-row justify-center items-center gap-4 w-full">
            ...
            <button
              type="submit"
              className="bg-gradient-to-t from-[#e72434] to-[#030305] px-4 py-2 text-white rounded-full hover:bg-sky-600"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-6 text-sm">
        <div className="flex items-center">
          ...
          <p>2024 Iswiss Bank. All Rights Reserved.</p>
        </div>
